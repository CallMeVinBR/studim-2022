...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="nota_style.css" />
</head>
<body>
  ...
  <div class="col-lg-12">
    <table class="table table-striped table-hove">
        <tr>
            ...
            <th class="col-md-1 col-sm-1" scope="col">Bi. 1</th>
            <th class="col-md-1 col-sm-1" scope="col">Bi. 2</th>
            <th class="col-md-1 col-sm-1" scope="col">Bi. 3</th>
            <th class="col-md-1 col-sm-1" scope="col">Bi. 4</th>
            <th class="col-md-1 col-sm-1" scope="col">Média</th>
        </tr>
    <?php
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="list-group">
              <a href="menu.html" style="text-decoration: none"><button type="button" class="list-group-item list-group-item-action">Menu</button></a>
              <a href="registro.php" style="text-decoration: none"><button type="button" class="list-group-item list-group-item-action">Cadastrar</button></a>
          </div>
        </div>
